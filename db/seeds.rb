...
Bank.create!(:id=>1,:title=>'우리은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>2,:title=>'경남은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>3,:title=>'광주은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>4,:title=>'기업은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>5,:title=>'농협',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>6,:title=>'대구은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>7,:title=>'도이치은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>8,:title=>'부산은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>9,:title=>'비엔피파리바은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>10,:title=>'산림조합',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>11,:title=>'산업은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>12,:title=>'상호저축은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>13,:title=>'새마을금고',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>14,:title=>'수출입은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>15,:title=>'수협중앙회',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>16,:title=>'신용협동조합',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>17,:title=>'신한은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>18,:title=>'외환은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>19,:title=>'우체국',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>20,:title=>'전북은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>21,:title=>'제주은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>22,:title=>'하나은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>23,:title=>'BOA(뱅크오브아메리카)',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>24,:title=>'HSBC',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>25,:title=>'JP모간 체이스',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>26,:title=>'SC은행',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>27,:title=>'우리투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>28,:title=>'교보증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>29,:title=>'대신증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>30,:title=>'대우증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>31,:title=>'동부증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>32,:title=>'동양증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>33,:title=>'메리츠증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>34,:title=>'미래에셋증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>35,:title=>'부국증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>36,:title=>'삼성증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>37,:title=>'신영증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>38,:title=>'신한금융투자',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>39,:title=>'아이엠투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>40,:title=>'유진투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>41,:title=>'이트레이드증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>42,:title=>'키움증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>43,:title=>'하나대투증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>44,:title=>'하이투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>45,:title=>'한국투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>46,:title=>'한화투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>47,:title=>'현대증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>48,:title=>'HMC투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>49,:title=>'LIG투자증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>50,:title=>'NH농협증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
Bank.create!(:id=>51,:title=>'SK증권',:photo=>File.open(Rails.root.join("public", "images", "lovely_dog.jpg")))
